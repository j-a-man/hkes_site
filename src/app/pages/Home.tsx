...
export default function Home() {
  ...
  return (
    <div className="bg-white overflow-hidden font-['Poppins']">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative z-10 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap items-center gap-6 mb-16">
              ...
              <Link
                to="/about"
                className="text-gray-600 font-bold tracking-wider text-sm transition-colors hover:text-[#fa4e5b] underline underline-offset-4"
              >
                ABOUT US
              </Link>
            </div>
          ...
          <div className="relative z-10 hidden lg:flex justify-end items-center right-0 h-[600px] w-full max-w-lg ml-auto perspective-[1000px]">
             ...
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-[26rem] bg-white/20 backdrop-blur-md p-3 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/50 z-20 animate-[float_6s_ease-in-out_infinite] group">
                <img 
                ...
                <div className="absolute inset-0 rounded-[1.5rem] bg-gradient-to-t from-black/60 to-transparent flex items-end p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="text-white font-bold text-lg tracking-wider">Victoria Harbour</span>
                </div>
             </div>

             {/* Top Right Image - Neon Signs / Street */}
             <div className="absolute top-10 -right-4 w-48 h-56 bg-white/30 backdrop-blur-xl p-2 rounded-[1.5rem] shadow-[0_15px_40px_rgba(250,78,91,0.2)] border border-white/60 z-30 animate-[float_8s_ease-in-out_1s_infinite] group rotate-6 hover:rotate-0 transition-transform duration-500">
                <img 
                  src="https://images.unsplash.com/photo-1565158655169-be05af20b66a?q=80&w=400&auto=format&fit=crop" 
             ...
             <div className="absolute bottom-10 -left-8 w-56 h-48 bg-white/30 backdrop-blur-xl p-2 rounded-[1.5rem] shadow-[0_15px_40px_rgba(250,78,91,0.2)] border border-white/60 z-30 animate-[float_7s_ease-in-out_2.5s_infinite] group -rotate-6 hover:rotate-0 transition-transform duration-500">
                <img 
